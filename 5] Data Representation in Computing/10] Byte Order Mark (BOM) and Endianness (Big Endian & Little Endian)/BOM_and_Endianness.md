...
When we transfer data on network we need to tell receiving system which method we are using or receiving system can read our data wrong.

425A method is called Big Endian.
5A42 method is called Little Endian.
